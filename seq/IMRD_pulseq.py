...
class IMRD(blankSeq.MRIBLANKSEQ):
    def __init__(self):
        ...
        self.addParameter(key='seqName', string='Sequence Name', val='IMRD',
    ...
    def sequenceRun(self, plot_seq=False, demo=False, standalone=False):
        ...
        bandwith_short = nPoints/ (((3e4 / 4)- hw.deadTime ) * 1e-6)
        bandwith_long= nPoints/ (((3 * 5e5 / 4)- hw.deadTime ) * 1e-6)
        ...
        waveforms_long, n_readouts_long, n_adc_long = createBatches(case='long')
